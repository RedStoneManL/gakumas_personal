...
2026-09-18 可选关系网络升级：见 [V6 迁移与训练指导](RELATIONAL_V6_TRAINING.md) 和 [本地验收范围](RELATIONAL_V6_ACCEPTANCE.md)。保留原 Ascend 底层适配；使用现有权重在新目录热启动，先在服务器预检，再启长训练。原 V5 配置仍可使用。
